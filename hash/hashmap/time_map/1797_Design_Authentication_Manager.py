...
time t (renew or countUnexpiredTokens), the expiration takes place before the other actions.
...
# Key Note:
# 1. the difference between this problem and 981 is for this one, the 
# value is just a single value, so we can use values() to access the 
# values directly.
