...
# Key Note:
# 1. as long as operation2 is legal, operation1 will be legal too, 
# because operation1 just all freqs == 1.
# 2. to make operation2 legal, we need to make sure that the elements
# in two strings are the same(set)
# 3.then, we need to make sure the values are the same(despite the 
# keys).
