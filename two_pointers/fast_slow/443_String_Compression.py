...
# Key Note:
# 1. we need two while to make sure we dont cross the index
# 2. if we only use one while loop, we need to add last group by
# ourselves in the end.(second solution here)
