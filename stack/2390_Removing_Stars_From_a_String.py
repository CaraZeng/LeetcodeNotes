...
Input: s = "erase*****"
Output: ""
Explanation: The entire string is removed, so we return an 
empty string.
...
# Key Note:
# 1. before pop from a stack, always make sure its not empty,
# actually for this problem, we dont need to check it, since
# the first c wont be "*" and we wont pop out from stack when
# its empty, but its a good habit.
