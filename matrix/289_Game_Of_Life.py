...
# Key Note:
# 1. this is not the best solution but its easy to understand
# 2. just use a copy board to iterate though every cell and record their neighbors
# then do the adjustment based on their neigbors's states.
