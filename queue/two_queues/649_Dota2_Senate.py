...
The character 'R' and 'D' represent the Radiant party and the 
Dire party. Then if there are n senators, the size of the given 
string will be n.
...
Suppose every senator is smart enough and will play the best strat
egy for his own party. Predict which party will finally announce 
the victory and change the Dota2 game. The output should be 
"Radiant" or "Dire".
...
# Key Note:
# 1. since both senate parties can ban the other one, the one who
# came first has the advantages to ban the other one(came later),
# and if the first one ban the other one successfully, it can stay,
# and if one party cancells the whole another party, it can declare
# it wins.
